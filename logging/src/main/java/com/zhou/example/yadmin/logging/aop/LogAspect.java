/**
 * <p>
 * 文件名称:    com.zhou.example.yadmin.common.aop.LogAspect
 * </p>
 */
package com.zhou.example.yadmin.logging.aop;
...
import com.zhou.example.yadmin.common.utils.ExceptionUtils;
...
public class LogAspect extends AbstractBaseComponent
{
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.zhou.example.yadmin.logging.aop.annotation.Log)")
